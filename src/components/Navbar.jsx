  ...
  const mobileMenu = (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          {/* Close button */}
          <div style={{ position: "absolute", top: "1rem", right: "1.5rem", zIndex: 9999 }}>
            <button
              type="button"
              onClick={() => setIsOpen(false)}
              className="text-gray-400 hover:text-white transition-colors p-3 select-none"
      ...
      >
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <button
            ...
            className="md:hidden text-gray-400 hover:text-white transition-colors p-3 -mr-2 select-none relative z-[9999]"
            style={{ touchAction: "manipulation", WebkitTapHighlightColor: "transparent" }}
            aria-label="Menü"
          >
